...
const Login = () => {
  ...
  return (
    <div
      className=" min-h-screen flex flex-wrap justify-end  h-screen w-full bg-cover bg-center"
      style={{ backgroundImage: `url(${bgImg})` }}
    >
      <div className="  flex justify-center items-center w-full h-auto max-w-lg bg-white p-8  shadow-lg">
        <div className="w-[61.1vh]">
