...
export default function TransactionForm() {
  ...
  <div className="space-y-6">
    ...
    {/* Voucher Information */}
    <div className="bg-gray-50 rounded-lg p-4 space-y-4">
      <h3 className="font-semibold text-gray-700 text-sm uppercase tracking-wide">Voucher Information</h3>
    ...
    {/* Transaction Details */}
    <div className="bg-gray-50 rounded-lg p-4 space-y-4">
      <h3 className="font-semibold text-gray-700 text-sm uppercase tracking-wide">Transaction Details</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-3">Mode of Deposit</label>
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="Cash" className="ml-3 text-sm font-medium text-gray-700">Cash</label>
            </div>
            <div className="flex items-center">
              <input
                type="radio"
                ...
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="Online" className="ml-3 text-sm font-medium text-gray-700">Online</label>
            </div>
          </div>
        </div>
